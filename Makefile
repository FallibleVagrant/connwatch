...
SRC_DIR = ./src
OBJ_DIR = ./obj
SOURCES += $(SRC_DIR)/main.cpp $(SRC_DIR)/info_window.cpp $(SRC_DIR)/connections_window.cpp $(SRC_DIR)/action_window.cpp $(SRC_DIR)/window_demon.cpp $(SRC_DIR)/ncurses_funcs.cpp $(SRC_DIR)/controller_god.cpp $(SRC_DIR)/model_angel.cpp
